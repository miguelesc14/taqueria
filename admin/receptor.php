...
$pdt_identity_token = 'Ggbna_4BGcHQTmu8ThY27gOL-yTZ53lnBr2soOb1EC0zKbqBybe6r2v1Zfq';
...
if (strcmp($lines[0], "SUCCESS") == 0) {
    ...
    Recibimos $mc_gross pesos mexicanos en concepto de: $quantity $item_name.<hr>
    Vuelve a comprar dando clic <a href='$baseUrl/formulario.php'>aquí</a>";
    return;
} else if (strcmp($lines[0], "FAIL") == 0) {
    // Registramos datos para realizar una investigación
    echo "<h1>¡Hemos procesado tu pago exitosamente!</h1> 
    Vuelve a comprar dando clic <a href='$baseUrl/menuclient.php'>aquí</a>";
    return;
}
